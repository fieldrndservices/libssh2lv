...
19. Enter `libssh2` for the _Project name:_. Optionally, uncheck the _Use default location_ checkbox and a path for the _Location_ field. The default location should be NI Eclipse's workspace. Click the _Next >_ button. A new page will appear.
